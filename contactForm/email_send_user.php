...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p>We have received your message and truly appreciate you taking the time to contact Starbeans Ceylon. Our team will review your inquiry as soon as possible.</p>
            ...
            <p style="margin-top: 30px;">
                Warm regards,</br>
                <strong>The Starbeans Ceylon Team</strong>
            </p>
        </div>
        
        <!-- Footer -->
        <div class="footer">
            <p><strong>Starbeans Ceylon</strong></p>
            
            <div class="social-links">
                <a href="https://starbeans.ceylonlensmedia.com/">Website</a> |
                <a href="#">Facebook</a> |
                <a href="#">Instagram</a>
            </div>
